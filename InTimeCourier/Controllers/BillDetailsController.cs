...
namespace InTimeCourier.Controllers
{
    ...
    public class BillDetailsController : Controller
    {
        ...
        public ActionResult AddBillDetails(BillDetails billDetails)
        {
            ...
            var courrierRes = objDb.Exec_SPrc<CorierResponse>(sprcname, Paramenters, "InLogisticModel", "intimelogisticjeetu", true).FirstOrDefault();
        ...
        public IEnumerable<BillPayment> GetPaymentDetails(BillPayment payment)
        {
            ...
            return objDb.Exec_SPrc<BillPayment>(sprcname, Paramenters, "InLogisticModel", "intimelogisticjeetu", true);
        }
